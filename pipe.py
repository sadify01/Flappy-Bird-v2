...
class Pipe:
    def __init__(self):
        self.pipe_top = pygame.image.load(os.path.join('assets', 'pipe_top.png')).convert_alpha()
        self.pipe_top = pygame.transform.scale(self.pipe_top, (pipe_width, pipe_height))
        self.pipe_top_x_pos = game_width
        self.pipe_top_y_pos = random.randint(-700, -200)
        ...
        self.pipe_bottom = pygame.image.load(os.path.join('assets', 'pipe_bottom.png')).convert_alpha()
