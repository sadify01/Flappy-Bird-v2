import pygame
import os
from settings import bird_width, bird_height, bird_color, game_width, game_height, frame, bird_rotation, bird_movement, frame_counter, frame_counter2, dt, gravity
...
class Bird:
    def __init__(self):
        ...
        for num in range(1, 5):
            bird = pygame.image.load(os.path.join('assets', f'bird_{bird_color}_{num}.png')).convert_alpha()
